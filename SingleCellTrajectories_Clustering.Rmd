...
setwd('/Users/thomasyoung/Dropbox/MovieProcessing/SSA_OtherAnalyses/')
...
The data consists of cells that start off YFP negative.  This restriction is needed to exclude RFP- cells, since these tend to be YFP positive. This notebook is only concerned about the trajectories of RFP positive cells.
